...
export const recordPayment = async (req, res) => {
    ...
    try {
        ...
        const paymentSql = "INSERT INTO payments (order_id, payment_method, payment_amount, change_amount, payment_status) VALUES (?, ?, ?, ?, 'paid')";
        const [paymentResult] = await connection.query(paymentSql, [order_id, payment_method, payment_amount , change_amount || 0]);
